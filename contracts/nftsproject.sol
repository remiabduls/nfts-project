...
contract nftsproject is ERC721URIStorage {
    ...
    constructor() ERC721("PATRICKSTARNFT", "PATRICK") {
        console.log("Welcome, This is your NFt!");
    }
    ...
    function getTotalNFTaMintedSoFar() external view returns (uint256) {
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        combinedWord,
                        '", "description": "A highly acclaimed collection of patrickstar.", "image": "data:image/svg+xml;base64,',
